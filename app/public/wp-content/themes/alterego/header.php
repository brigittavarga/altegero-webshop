...
<div id="page" class="site">
	...
	<header id="masthead" class="site-header flex" style="<?php category_header_background(); ?>">
		...
		<!-- here we have a link with our logo that goes back to the homepage --> 
		<a href="<?php echo get_site_url(); ?>" class="absolute top-0 left-0 logo">
			<img src="<?php echo get_template_directory_uri() . "/img/alter-ego-logo.svg"; ?>" class="db" alt="Alterego Logo">
		</a>
		...
		<!-- our featured image will go here --> 
		<?php echo wp_get_attachment_image(51, "full"); ?> 
